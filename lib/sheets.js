...
export async function getMonthlyKPIs(sheetName) {
  const ranges = [
    ...
    "AB67", // [NUEVO] Ratio de Margen Real (Referencia)
  ];
  ...
  return {
    ...
    ventasTotales:       getValue(0),  // B5
    utilidadOperativa:   getValue(3),  // B10
    honorariosLaura:     getValue(4),  // B11
    ingresosReales:      getValue(5),  // B12
    egresosReales:       getValue(6),  // B13
    flujoCajaNeto:       getValue(7),  // B14
    puntoEquilibrio:     getValue(8),  // B16
    margenRentabilidad:  getValue(9),  // B18
    margenSeguridad:     getValue(10), // B20
    diaEquilibrio:       getValue(11), // B22
    indiceCobrabilidad:  getValue(12), // B24
    amortizaciones:      getValue(13), // B55
    ratioMargenReferencia: getValue(14), // AB67
  };
}
